import { unirseAula, unirUsuarioAula } from "./db/aulas.db.js";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  botonCrear.addEventListener("click", (event) => {
    ...
    const nuevaClase = {
      ...
      idUsuario: obtenerIdUsuario() // Obtener el ID del usuario actual
    };
    ...
    unirUsuarioAula(obtenerIdUsuario(), nuevaClase.idAula); // Unir al usuario a la clase creada
